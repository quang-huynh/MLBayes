...
## ---- echo = FALSE, fig.cap = 'Figure 1. Traceplot of model parameters from MCMC iterations. Z_duration is the p vector as described in the text.', fig.height = 5, fig.width = 7----
load('result.stan.dirichlet.more.iter.RData')
rstan::traceplot(result.stan, pars = c('Z', 'Z_duration', 'sigma'))

## ---- echo = FALSE, fig.cap = 'Figure 2. Marginal posterior distributions of model parameters. Z_duration is the p vector as described in the text.', fig.height = 5, fig.width = 7----
